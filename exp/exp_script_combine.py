...
ATTACKERS = ["AdvBench", "HEx-PHI", "DeepInception"]  # "Just-Eval", "GCG", "AutoDAN", "PAIR",
...
ATTACKERS = [ "AdvBench", "HEx-PHI", "DeepInception", "GCG", "PAIR"]  # "Just-Eval", "GCG", "AutoDAN", "PAIR",
DEFENDERS = [ "LayerBugFixer"] # "LayerBugFixer", "Unlearning"
# DEFENDERS = ["LayerBugFixer", "Unlearning"]  # "LayerBugFixer" "Unlearning"


MODEL_NAMES = ["mistral"]  # "llama2"
ATTACKERS = [ "AdvBench", "HEx-PHI", "DeepInception", "GCG", "PAIR"] #, "GCG", "AutoDAN", "PAIR",
defenders_edit = ['LayerBugFixer', 'Unlearning', 'SafeDecoding']
defenders_prompt = ['Paraphrase'] #  'Retokenization', 'Self-Reminder', 'ICD', 'PPL'

MODEL_NAMES = ["llama2"]  # "llama2"
ATTACKERS = [ "AdvBench", "HEx-PHI", "DeepInception", "GCG", "PAIR"] #, "GCG", "AutoDAN", "PAIR",
defenders_edit = ['LayerBugFixer', 'Unlearning', 'SafeDecoding']
defenders_prompt = ['Paraphrase', 'Self-Exam'] #  'Retokenization', 'Self-Reminder', 'ICD', 'PPL'


MODEL_NAMES = ["llama2", "mistral"]  # "llama2"
ATTACKERS = [ "AdvBench", "HEx-PHI", "DeepInception", "GCG", "PAIR"] #, "GCG", "AutoDAN", "PAIR",
defenders_edit = ['LayerBugFixer', 'Unlearning', 'SafeDecoding']
defenders_prompt = ['Retokenization', 'PPL'] #  'Retokenization', 'Self-Reminder', 'ICD', 'PPL'

DEFENDERS = []
for defender_edit in defenders_edit:
    for defender_prompt in defenders_prompt:
        DEFENDERS.append(f"{defender_edit}+{defender_prompt}")

LOG_FILE = f"command_logs_MODEL_NAMES_{MODEL_NAMES}_defenders_{DEFENDERS}.json"

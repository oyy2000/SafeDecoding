...
ATTACKERS = ["Base64", "Leetspeak"]  # "Just-Eval", "GCG", "AutoDAN", "PAIR",
# DEFENDERS = ["SafeDecoding", "Self-Exam", "no_defense"] # "LayerBugFixer" "Unlearning"
DEFENDERS = ["SafeDecoding", "Paraphrase", "LayerBugFixer", "Unlearning", "Self-Exam", "no_defense", "PPL"]  # "LayerBugFixer" "Unlearning"

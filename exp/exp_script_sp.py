...
LOG_FILE = f"command_log_special_3.json"
...
def main():
    ...
    # Specify the combinations you want
    combinations = [
        
        ["llama2", "ICD", "AdvBench"],
        
        ["mistral", "Self-Reminder", "HEx_PHI"],
         ["llama2", "Paraphrase", "HEx_PHI"],
         
        ["llama2", "LayerBugFixer", "HEx_PHI"],        
        
        # ["llama2", "Paraphrase", "AdvBench"],
        # ["llama2", "Self-Reminder", "HEx_PHI"],
        # ["llama2", "SafeDecoding", "AdvBench"],
        # ["mistral", "Retokenization", "DeepInception"],
        # ["mistral", "Self-Exam", "DeepInception"],
        # ["mistral", "Self-Exam", "HEx_PHI"],
        # ["mistral", "Self-Exam", "AdvBench"],
        # ["mistral", "no_defense", "HEx_PHI"],
        # ["mistral", "no_defense", "AdvBench"],
        # ["mistral", "PPL", "DeepInception"],
        # ["mistral", "Paraphrase", "DeepInception"],
        # ["mistral", "Paraphrase", "HEx_PHI"],
    ]

    task_queue = Queue()
    commands = []
    
    # Only build commands for the specified combinations
    for model_name, defender,attacker  in combinations:

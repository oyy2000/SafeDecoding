...
DEFENDERS = ["no_random_unlearning_1", "no_random_unlearning_2"]  # "LayerBugFixer" "Unlearning"


LOG_FILE = f"command_MODEL_NAMES_{MODEL_NAMES}_defenders_{DEFENDERS}.json"
